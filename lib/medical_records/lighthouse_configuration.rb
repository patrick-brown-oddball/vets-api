...
# lib/medical_records/private.pem
        ...
        def scopes
            'launch system/Patient.read system/AllergyIntolerance.read system/Immunization.read system/Observation.read system/DocumentReference.read system/DiagnosticReport.read system/Condition.read'
        end
