...
module Requests
  class PdfGenerator2122a
    include Swagger::Blocks

    swagger_path '/representation_management/v0/pdf_generator2122a' do
      operation :post do
        key :summary, 'Generate a PDF for form 21-22a'
        key :operationId, 'createPdfForm2122a'
